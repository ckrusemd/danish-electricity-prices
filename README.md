...
- Models the 2026 consumer price for Copenhagen/Radius/Andel TimeEnergi, with all variable and fixed components documented in [PRICE_COMPONENTS.md](PRICE_COMPONENTS.md)
